...
namespace scene
{
	...
	struct SAnimatedMesh : public IAnimatedMesh
	{
		...
		virtual core::array<core::stringc> getAnimationList() const {
            return AnimationList;
        }

        virtual void addAnimation(core::stringc name, int start, int end) {
            AnimationList.push_back(name);
            std::pair<int, int> frame(start, end);
            AnimationFrame.push_back(frame);
        }

//        virtual std::pair<int, int> getAnimationFrame(core::stringc name) {
//            return AnimationFrame[0];
//        };

        virtual void playAnimation(const core::stringc name) {
            // TODO
        }
		...
		core::array<core::stringc> AnimationList;
		core::array<std::pair<int, int>> AnimationFrame;
