...
namespace scene
{
	...
	public:
		//! Gets animation list
		virtual core::array<core::stringc> getAnimationList() const = 0;

        //! Get animation frame loop
		//virtual std::pair<int, int> getAnimationFrame(core::stringc name) = 0;
		...
		struct SJoint
		{
            ...
            core::map<int, core::array<SWeight*>> WeightsArray;
        ...
        virtual void addMeshBuffer(SSkinMeshBuffer* meshBuffer) = 0;

		//! Adds a new joint to the mesh, access it as last one
		virtual SJoint* addJoint(SJoint *parent=0) = 0;
        
        virtual void pushJoint(SJoint* joint) = 0;
