...
namespace scene
{
	...
	**/
	...
	public:
        ...
        //! Gets animation list
        virtual core::array<core::stringc> getAnimationList() = 0;

        // ! Play a animation clip / NULL == all
        virtual void playAnimation(core::stringc) = 0;
        ...
        virtual void enableOutline(const video::SColorf& outlineColor = video::SColorf(1.0, 0.0, 0.0), f32 outlineOffset = 0.2, bool isTransparentUse = false) = 0;
        
        virtual void disableOutline() = 0;
        
        virtual bool isEnableOutline() const = 0;
        
        virtual core::aabbox3df getAnimationTransformAABB() = 0;
        
        virtual void setCustomConfig(video::CCustomModelConfig* config) = 0;
        
        virtual video::CCustomModelConfig* getCustomConfig() = 0;
        
        virtual void SetTweenRotation(const core::vector3df& tweenRotation) = 0;

		virtual core::vector3df GetTweenRotation() = 0;
        
        virtual void SetTweenTranslation(const core::vector3df& tweenTranslation) = 0;

		virtual core::vector3df GetTweenTranslation() = 0;
        
        virtual void SetTweenScale(const core::vector3df& tweenScale) = 0;

		virtual core::vector3df GetTweenScale() = 0;
        
        virtual core::matrix4 GetTweenTransformation() = 0;
