...
namespace video
{
	...
	enum E_MATERIAL_TYPE
	{
        ...
        EMT_PBS_TRANSPARENT,
        EMT_PBS_BUMPED,
        EMT_PBS_TRANSPARENT_BUMPED,
        EMT_PBS_STANDARD,
        EMT_PBS_STANDARD_TRANSPARENT,
		EMT_PBS_STANDARD_GLASS,
        EMT_PBS_STANDARDBUMPED,
        EMT_PBS_STANDARDBUMPED_TRANSPARENT,
		EMT_PBS_STANDARDBUMPED_GLASS,
		EMT_PBS_ANISOTROPY,
        EMT_FRAMEANIMATION,
        EMT_GLASS,
		EMT_BUMPEDGLASS,
	...
	const char* const sBuiltInMaterialTypeNames[] =
	{
		...
		"JD/PBS/Transparent",
		"JD/PBS/Bumped",
		"JD/PBS/Bumped Transparent",
		"JD/PBS/Standard",
		"JD/PBS/Standard Transparent",
		"JD/PBS/Standard Glass",
		"JD/PBS/Standard Bumped",
		"JD/PBS/Standard Bumped Transparent",
		"JD/PBS/Standard Bumped Glass",
		"JD/PBS/Anisotropy",
		"JD/FrameAnimation",
		"JD/Glass",
		"JD/Bumped Glass",
