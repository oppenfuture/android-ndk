...
namespace video
{
	...
	{
		core::stringc Name;
		SMaterial InitMaterial;
		core::array<IMaterialRenderer*>  Renderers;
	};
	...
	*/
	...
	public:
		...
		*/
		...
		virtual ITexture* createTexture(GLenum target,u32 width,u32 height,GLsizei dataSize, GLenum internalformat,void * data,u32 layer = 0) =0;
		...
		void drawIndexedTriangleList(const S3DVertex* vertices,
			u32 vertexCount, const u32* indexList, u32 triangleCount)
		{
		...
		*/
		...
		virtual s32 addMaterialRenderer(core::array<IMaterialRenderer*> renderers,SMaterial initMaterial, const core::stringc  name) =0;
		virtual void CreateCustomMaterialRenderers(const char &renderSettingChar) =0;
		...
		virtual SMaterialRenderer* getMaterialRenderer(const core::stringc name) =0;
		...
		properties. */
		virtual io::IAttributes* createAttributesFromMaterial(const video::SMaterialPass& materialPass,
		...
		*/
        ...
        //reset render status in driver and handler
        virtual void resetRenderStatus(){}
	};
