...
enum E_VERTEX_TYPE
{
    ...
    //! 2017/10/18 For bump map and AO map, use two coords and tangents together.
...
struct S3DVertex2TCoordsTangents : public S3DVertex
{
    //! default constructor
    S3DVertex2TCoordsTangents() : S3DVertex() {}
    ...
    //! Equality operator
    bool operator==(const S3DVertex2TCoordsTangents& other) const
    {
        return ((static_cast<S3DVertex>(*this)==other) &&
                (TCoords2 == other.TCoords2) &&
                (Tangent == other.Tangent) &&
    ...
    bool operator<(const S3DVertex2TCoordsTangents& other) const
    {
        return ((static_cast<S3DVertex>(*this) < other) ||
                ((static_cast<S3DVertex>(*this) == other) && (TCoords2 < other.TCoords2)) ||
                ((static_cast<S3DVertex>(*this) == other) && (TCoords2 == other.TCoords2) && (Tangent < other.Tangent)) ||
                ((static_cast<S3DVertex>(*this) == other) && (TCoords2 == other.TCoords2) && (Tangent == other.Tangent) && (Binormal < other.Binormal)));
    }
    ...
    S3DVertex2TCoordsTangents getInterpolated(const S3DVertex2TCoordsTangents& other, f32 d)
    {
        d = core::clamp(d, 0.0f, 1.0f);
        S3DVertex2TCoordsTangents stt;
        stt.Pos = Pos.getInterpolated(other.Pos, d);
        stt.Normal = Normal.getInterpolated(other.Normal, d);
        stt.Color = Color.getInterpolated(other.Color, d);
        stt.TCoords = TCoords.getInterpolated(other.TCoords, d);
        stt.TCoords2 = TCoords2.getInterpolated(other.TCoords2, d);
        stt.Tangent = Tangent.getInterpolated(other.Tangent, d);
        stt.Binormal = Binormal.getInterpolated(other.Binormal, d);
        return other;
    }
};
