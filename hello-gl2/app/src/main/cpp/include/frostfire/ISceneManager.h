...
namespace scene
{
	...
	*/
	...
	public:
        ...
        virtual IAnimatedMesh* getMesh(IAnimatedMeshSceneNode** rootNode, const io::path& filename, bool genTangent) = 0;
		...
		virtual ISceneNode* addCubeSceneNode(video::E_MATERIAL_TYPE materialType, f32 size=10.0f, ISceneNode* parent=0, s32 id=-1,
			const core::vector3df& position = core::vector3df(0,0,0),
			const core::vector3df& rotation = core::vector3df(0,0,0),
			const core::vector3df& scale = core::vector3df(1.0f, 1.0f, 1.0f)) = 0;
		...
		pointer should not be dropped. See IReferenceCounted::drop()
		for more information. */
		virtual ISceneNode* addSphereSceneNode(video::E_MATERIAL_TYPE materialType, f32 radius=5.0f, s32 polyCount=16,
		...
		virtual ISceneNode* addCustomMeshSceneNode(video::SMaterial* material, const float* vertices,const uint32_t& vertices_count,
												   const uint32_t* indices,const uint32_t& indices_count) =0;
		...
		*/
		...
		virtual  ISceneNode* addSkySphereSceneNode(video::E_MATERIAL_TYPE materialType, f32 radius=5.0f, s32 polyCount=16, ISceneNode* parent=0, s32 id=-1,
												   const core::vector3df &position = core::vector3df(0, 0, 0),
												   const core::vector3df &rotation = core::vector3df(0, 0, 0),
												   const core::vector3df &scale = core::vector3df(1.0f, 1.0f, 1.0f)) = 0;

		virtual  ISceneNode* addSkyQuadSceneNode(video::E_MATERIAL_TYPE materialType, ISceneNode *parent,
												 ISceneManager *mgr, s32 id,
												 const core::vector3df &position = core::vector3df(0, 0, 0),
												 const core::vector3df &rotation = core::vector3df(0, 0, 0),
												 const core::vector3df &scale = core::vector3df(1.0f, 1.0f, 1.0f)) = 0 ;

		virtual  ISceneNode* addForeGroundSceneNode(video::E_MATERIAL_TYPE materialType, ISceneNode *parent,
												  ISceneManager *mgr, s32 id,
												  const core::vector3df &position = core::vector3df(0, 0, 0),
												  const core::vector3df &rotation = core::vector3df(0, 0, 0),
												  const core::vector3df &scale = core::vector3df(1.0f, 1.0f, 1.0f)) = 0;

		virtual ISceneNode* addQuadSceneNode(video::E_MATERIAL_TYPE materialType, ISceneNode *parent,
												   ISceneManager *mgr, s32 id,
												   const core::vector3df &position = core::vector3df(0, 0, 0),
												   const core::vector3df &rotation = core::vector3df(0, 0, 0),
												   const core::vector3df &scale = core::vector3df(1.0f, 1.0f, 1.0f)) = 0;
		...
		*/
		 ...
		 *  -5  模型版本不能使用当前引擎版本
		 */
        virtual int LoadCustomConfigModel(const char* fileName, const char* password, IAnimatedMeshSceneNode** node, video::CCustomModelConfig** config) = 0;
         ...
         *  -5   模型版本不能使用当前引擎版本
         */
        virtual int LoadCustomModelWithConfig(const char* configPath, const char* archivePath, const char* modelPath, IAnimatedMeshSceneNode** node, video::CCustomModelConfig** config) = 0;
        
        virtual bool HasFrameAnimation(IAnimatedMeshSceneNode* node) = 0;
        
        virtual void RecursivelyGetNode(IAnimatedMeshSceneNode* node, core::array<IAnimatedMeshSceneNode*>& nodeList) = 0;
	};
